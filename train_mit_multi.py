...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan  3 15:27:54 2019
...
from utils.utils import AverageMeter, colorEncode, accuracy ,  pixel_acc, as_numpy  # intersectionAndUnion
...
RESTORE_FROM = "./models/pretrained/resnet50-places365.pth"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default='ASPNet50', 
                        help="Availabel options: ATDNext50, ASPNet50, DeepLab50,DeepLabv3_50...")
    ...
    parser.add_argument("--lambda_branch", type=float, default= 0.02,
                        help="lambda_branch.")
    ...
    args.id += '-lamda' + str(args.lambda_branch)
    args.id += '-epoch' + str(args.num_epoches)
    args.id += '-BN_v53so'        # BN or SyncBN

...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 17 16:55:13 2018
...
# RESTORE_FROM = './checkpoints/ADE2016-DeepLabv3_50-ngpus2-batchSize14-h384-w384-lr0.008-epoch120-BN-ASPPv2-SP/DeepLabv3_50_epoch120.pth'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default='DeepLabv3At_50',  # Change
                        help="Availabel options: ASPNet50, DASPNet50, PSPNet50, DeepLab50, DeepLabv3_50...")
    ...
    parser.add_argument('--imgSize', type=tuple, default=(384, 384),  # (384, 384) , (512, 512), (512, 683) (224, 224)
    ...
    parser.add_argument("--result", type=str, default="./result/eval/s3337max",

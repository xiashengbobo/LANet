...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 23 17:58:11 2018
...
# 提供了暴露接口用的“白名单”
__all__ = ['ATRNeXt', 'ATRNext50', 'ATRNext101', 'ATRNext152'] 
...
class SENeXt(nn.Module):
    ...
    ***
    ...
    def __init__(self, block, layers, num_classes, norm_layer=None, groups=32, dilate_scale=8):
        self.inplanes = 64
        ...
        self.conv_last = nn.Sequential(
                nn.Conv2d(1024 * block.expansion, 512, kernel_size=3, padding=1, 
                          bias=False),
                norm_layer(512),

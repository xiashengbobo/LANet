...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  3 12:14:27 2018
...
from utils.utils import AverageMeter, colorEncode, accuracy, pixel_acc, as_numpy # 
...
def main(args):
    ...
    val_loader = data.DataLoader(val_dataset,
                                  batch_size = 10, # args.batch_size 8
                                  shuffle = False,
                                  num_workers = 16,
                                  pin_memory = True,
                                  drop_last = True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default= 'DeepLabv3At_50', 
                        help="Availabel options:  DeepLab50,DeepLabv3_50, DeepLabv3At_50,SE_resnet50, SE_resnext50...")
    ...
    parser.add_argument('--batch_size_per_gpu', type=int, default=7, 
                        help='input batch size')
    parser.add_argument('--num_epoches', type=int, default=120, # 20 50 60 70 80 100
    ...
    parser.add_argument('--num_val', type=int, default=320,   # 128
    ...
    args.id += '-BN-ASPP'        # BN or SyncBN  BN-v53si
